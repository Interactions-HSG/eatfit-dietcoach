...
urlpatterns = [
     ...
     url(r'^products/worse-products/(?P<gtin>\d{0,50})/', NutritionService.views.views.get_worse_products_gtin),
     url(r'^products/worse-products/category/(?P<minor_category_pk>\d+)/', NutritionService.views.views.get_worse_products_minor_category),
     ...
     url(r'^receipt2nutrition/send-receipts-get-product-ids/$', views.SendReceiptsGetProductIdsView.as_view()),
